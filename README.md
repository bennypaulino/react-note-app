This project is the front-end for a Rails project, [notes-api](https://github.com/bennypaulino/notes-api), this project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
