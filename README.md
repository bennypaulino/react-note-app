This project is the front-end for a Rails project, [notes-api](https://github.com/bennypaulino/notes-api), and was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
